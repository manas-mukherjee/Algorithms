...
public class ResizeCapacityArrayBasedQueueOfStrings {
    private String[] s;
    private int N=0;

    public ResizeCapacityArrayBasedQueueOfStrings(){
        s = new String[1];
    }
    ...
    * Cost of inserting first N items - N + (2+4+...) = ~3N*/
    ...
    public static void main(String[] args) {
        ResizeCapacityArrayBasedQueueOfStrings stack = new ResizeCapacityArrayBasedQueueOfStrings();
        while (!StdIn.isEmpty()) {
